...
public struct ContentScreenView<Content: View>: View {
  ...
  private let backgroundIgnoresSafeArea: Bool
  ...
  public init(
    ...
    background: Color = DesignSystem.Styles.Colors.background,
    backgroundIgnoresSafeArea: Bool = false,
    ...
    self.backgroundIgnoresSafeArea = backgroundIgnoresSafeArea
  ...
  public var body: some View {
    ...
    .background(
      backgroundIgnoresSafeArea ? AnyView(background.ignoresSafeArea()) : AnyView(background)
    )
